...
public class UnitPanel extends JPanel {
	...
	private void buildUnitPanel() {
		...
		ImagePanel panelPIC = new ImagePanel(new ImageIcon(getClass().getResource("/images/Images.png")).getImage());
		
		JPanel panelImage = new JPanel();
		panelImage.add(panelPIC);
		...
		gl_panelSquadEditor.setHorizontalGroup(
			gl_panelSquadEditor.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelSquadEditor.createSequentialGroup()
					.addGap(74)
					.addGroup(gl_panelSquadEditor.createParallelGroup(Alignment.TRAILING)
					...
					.addComponent(panelImage, GroupLayout.PREFERRED_SIZE, 289, GroupLayout.PREFERRED_SIZE)
					.addGap(30))
		);
		gl_panelSquadEditor.setVerticalGroup(
			gl_panelSquadEditor.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_panelSquadEditor.createSequentialGroup()
					.addContainerGap(50, Short.MAX_VALUE)
					.addGroup(gl_panelSquadEditor.createParallelGroup(Alignment.LEADING)
						.addComponent(panelImage, GroupLayout.PREFERRED_SIZE, 209, GroupLayout.PREFERRED_SIZE)
						.addGroup(gl_panelSquadEditor.createSequentialGroup()
