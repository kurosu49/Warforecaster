...
//		
		//test buying a unit
		//trying to buy chrom(id=3) for tester(id=3) into squad1
		//currently, no units and balance = 700
//		//should be 625 after and have one StUnit
//		db.purchaseUnit(1, 5);
//		
...
//		}
		...
		db.purchaseStrategy(3, 1);


		//db.updateStUnits(3, 4, 14, 1, 1);

		
		
//		
//		db.updateFieldPosition(4, "Squad1", 3);
//		db.purchaseUnit(8, 3);
//		db.purchaseStrategy(1, 3);
//		db.purchaseStrategy(3, 1);
//		System.out.println("-----Getting StUnits-----");
//		List<StUnit> list7 = db.getStUnits(3);
//		for(StUnit t: list7) {
//			System.out.println(t.toString());
//		}
//		
//		System.out.println("-----Getting StUnits-----");
//		List<StStrategy> list9 = db.getStStrategyList(3);
//		for(StStrategy t: list9) {
//			System.out.println(t.toString());
//		}
		
//		db.updateTournamentStatus(2, 3);
		
//		
//		//System.out.println("-----Getting Squads-----");
//		List<StSquad> list8 = db.getStSquadList(3);
//		for(StSquad t: list8) {
